#credit: crhischoy
#small changes made by yurim lee
...
def voxel2mesh(voxels, surface_view):
    cube_verts = [[0, 0, 0], [0, -1/math.sqrt(2), 1/math.sqrt(2)], [0, 1/math.sqrt(2), 1/math.sqrt(2)], [0, 0, math.sqrt(2)], [math.sqrt(2), 0, 0], [1, -1/math.sqrt(2), 1/math.sqrt(2)], [1, 1/math.sqrt(2), 1/math.sqrt(2)], [1, 0, a]]  # 8 points
